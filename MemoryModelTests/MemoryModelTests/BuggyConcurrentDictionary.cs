...
/*============================================================
**
** Class:   BuggyConcurrentDictionary
**
**
...
namespace MemoryModelTests
{
    ...
    /// <remarks>
    /// All public and protected members of <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> are thread-safe and may be used
    /// concurrently from multiple threads.
    /// </remarks>
    [DebuggerTypeProxy(typeof(IDictionaryDebugView<,>))]
    [DebuggerDisplay("Count = {Count}")]
    public class BuggyConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
    {
        /// <summary>
        /// Tables that hold the internal state of the BuggyConcurrentDictionary
        ///
        ...
        /// cref="BuggyConcurrentDictionary{TKey,TValue}"/>
        /// class that is empty, has the default concurrency level, has the default initial capacity, and
        /// uses the default comparer for the key type.
        /// </summary>
        public BuggyConcurrentDictionary() : this(DefaultConcurrencyLevel, DefaultCapacity, true, null) { }
        ...
        /// <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> concurrently.</param>
        ...
        /// 0.</exception>
        public BuggyConcurrentDictionary(int concurrencyLevel, int capacity) : this(concurrencyLevel, capacity, false, null) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/>
        ...
        /// the new
        /// <see cref="BuggyConcurrentDictionary{TKey,TValue}"/>.</param>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="collection"/> is a null reference
        /// (Nothing in Visual Basic).</exception>
        /// <exception cref="T:System.ArgumentException"><paramref name="collection"/> contains one or more
        /// duplicate keys.</exception>
        public BuggyConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }
        ...
        public BuggyConcurrentDictionary(IEqualityComparer<TKey> comparer) : this(DefaultConcurrencyLevel, DefaultCapacity, true, comparer) { }
        ...
        /// <exception cref="T:System.ArgumentNullException"><paramref name="collection"/> is a null reference
        /// (Nothing in Visual Basic).</exception>
        public BuggyConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
            : this(comparer)
        {
        ...
        public BuggyConcurrentDictionary(
        ...
        /// </exception>
        public BuggyConcurrentDictionary(int concurrencyLevel, int capacity, IEqualityComparer<TKey> comparer)
            : this(concurrencyLevel, capacity, false, comparer)
        {
        }

        internal BuggyConcurrentDictionary(int concurrencyLevel, int capacity, bool growLockArray, IEqualityComparer<TKey> comparer)
        {
        ...
        /// <summary>
        /// Attempts to add the specified key and value to the <see cref="BuggyConcurrentDictionary{TKey,TValue}
        /// TValue}"/>.
        /// </summary>
        /// <param name="key">The key of the element to add.</param>
        /// <param name="value">The value of the element to add. The value can be a null reference (Nothing
        /// in Visual Basic) for reference types.</param>
        /// <returns>true if the key/value pair was added to the <see cref="BuggyConcurrentDictionary{TKey,TValue}
        /// TValue}"/>
        /// successfully; otherwise, false.</returns>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="key"/> is null reference
        /// (Nothing in Visual Basic).</exception>
        /// <exception cref="T:System.OverflowException">The <see cref="BuggyConcurrentDictionary{TKey,TValue}"/>
        ...
        /// <summary>
        /// Determines whether the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> contains the specified
        /// key.
        /// </summary>
        /// <param name="key">The key to locate in the <see cref="BuggyConcurrentDictionary{TKey,TValue}
        /// TValue}"/>.</param>
        /// <returns>true if the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> contains an element with
        ...
        /// <see cref="BuggyConcurrentDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <param name="key">The key of the element to remove and return.</param>
        /// <param name="value">When this method returns, <paramref name="value"/> contains the object removed from the
        /// <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> or the default value of <typeparamref
        /// name="TValue"/>
        ...
        /// the
        /// <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> with the specified key or the default value of
        /// <typeparamref name="TValue"/>, if the operation failed.</param>
        /// <returns>true if the key was found in the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/>;
        ...
        /// <summary>
        /// Removes all keys and values from the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/>.
        /// </summary>
        public void Clear()
        {
            int locksAcquired = 0;
        ...
        /// <summary>
        /// Copies the key and value pairs stored in the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> to a
        /// new array.
        /// </summary>
        /// <returns>A new array containing a snapshot of key and value pairs copied from the <see
        /// cref="BuggyConcurrentDictionary{TKey,TValue}"/>.</returns>
        ...
        /// cref="BuggyConcurrentDictionary{TKey,TValue}"/>.</summary>
        /// <returns>An enumerator for the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/>.</returns>
        /// <remarks>
        ...
        /// cref="BuggyConcurrentDictionary{TKey,TValue}"/>.</value>
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the <see
        /// cref="BuggyConcurrentDictionary{TKey,TValue}"/>. Should only be used after all locks
        /// have been aquired.
        /// </summary>
        /// <exception cref="T:System.OverflowException">The dictionary contains too many
        /// elements.</exception>
        ...
        /// <summary>
        /// Adds a key/value pair to the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> 
        ...
        /// <summary>
        /// Adds a key/value pair to the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> if the key does not already 
        /// exist, or updates a key/value pair in the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> if the key 
        /// already exists.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value that indicates whether the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> is empty.
        /// </summary>
        /// <value>true if the <see cref="BuggyConcurrentDictionary{TKey,TValue}"/> is empty; otherwise,
        /// false.</value>
        public bool IsEmpty
        {
            get
        ...
        /// cref="BuggyConcurrentDictionary{TKey,TValue}"/>.</exception>
        ...
        {
            return ((BuggyConcurrentDictionary<TKey, TValue>)this).GetEnumerator();
        }
        ...
        /// cref="T:System.Collections.Generic.BuggyConcurrentDictionary{TKey,TValue}"/>, this property always
        /// returns false.</value>
        ...
        /// cref="T:System.Collections.Generic.BuggyConcurrentDictionary{TKey,TValue}"/>.</value>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="key"/> is a null reference
        /// (Nothing in Visual Basic).</exception>
        /// <exception cref="T:System.ArgumentException">
        /// A value is being assigned, and <paramref name="key"/> is of a type that is not assignable to the
        /// key type <typeparamref name="TKey"/> of the <see
        /// cref="T:System.Collections.Generic.BuggyConcurrentDictionary{TKey,TValue}"/>. -or- A value is being
        /// assigned, and <paramref name="key"/> is of a type that is not assignable to the value type
        /// <typeparamref name="TValue"/> of the <see
        /// cref="T:System.Collections.Generic.BuggyConcurrentDictionary{TKey,TValue}"/>
        /// </exception>
        object IDictionary.this[object key]
        {
            ...
            set
            {
                ...
                ((BuggyConcurrentDictionary<TKey, TValue>)this)[(TKey)key] = (TValue)value;
            }
        }
        ...
        /// cref="T:System.Collections.Concurrent.BuggyConcurrentDictionary{TKey,TValue}"/>, this property always
        /// returns false.</value>
        ...
        private void GrowTable(Tables tables)
        {
            ...
            try
            {
                ...
                if (maximizeTableSize)
                {
                    ...
                    // calling Clear() on the BuggyConcurrentDictionary will shrink the table and lower the budget.)
                    _budget = int.MaxValue;
                }
        ...
        private sealed class DictionaryEnumerator : IDictionaryEnumerator
        {
            ...
            internal DictionaryEnumerator(BuggyConcurrentDictionary<TKey, TValue> dictionary)
            {
